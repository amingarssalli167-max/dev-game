...
const origHas=hasSave;
let falseCalls=0;
hasSave=function(){const r=origHas();if(!r)falseCalls++;return r;};
boot();
console.log('hasSave() returned false',falseCalls,'time(s) during boot');
console.log('btnCont style:',JSON.stringify($('btnCont').style));
console.log('btnCont is cached stub:',$('btnCont')===__els['btnCont']);
