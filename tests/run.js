...
boot();/* ---- mouse-look / camera-relative movement / 3D-only regression ---- */
let fails=0;
...
/* ---------------- view toggle ---------------- */
toggleView();chk(E3.view==='fps','V -> first person');
step(20);
chk(E3.playerRig.visible===false,'own body hidden in first person');
toggleView();chk(E3.view==='ots','V -> over the shoulder');
step(20);
chk(E3.playerRig.visible===true,'Alexei visible again over the shoulder');
