...
boot();function st(tag){
  console.log(tag,
    'hemi='+(E3.hemi?E3.hemi.intensity.toFixed(3):'-'),
    'amb='+(E3.amb?E3.amb.intensity.toFixed(3):'-'),
    'fog='+(E3.scene&&E3.scene.fog?E3.scene.fog.density.toFixed(3):'-'),
    'moon='+(E3.moon?E3.moon.intensity.toFixed(2)+'/'+E3.moon.visible:'-'),
    'world='+(E3.world?'yes':'no'),
    'builtFor='+(E3.builtFor||'-'));
}
boot(); st('after boot:');
startGame(true); st('after startGame:');
update3D(0.016); st('after update3D #1:');
update3D(0.016); st('after update3D #2:');
